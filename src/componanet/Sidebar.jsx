  ...
  return (
    <div className="w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex ">
      ...
      <div className="bg-[#121212] h-[85%] rounded">
        ...
        <div className="p-4 bg-[#242424] font-semibold flex m-2 rounded flex-col items-start justify-start gap-1 pl-4">
        ...
        <div className="p-4 bg-[#242424] font-semibold flex m-2 rounded flex-col items-start justify-start gap-1 pl-4 mt-4">

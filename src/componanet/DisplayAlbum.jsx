...
const DisplayAlbum = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="flex gap-8 mt-10 flex-col md:flex-row items-start">
        ...
        <div className="flex flex-col">
          ...
          <p className="mt-1">
            ...
            <b className="px-2">Spotify</b>•1,234,900 likes •
            <b className="p-1">50 songes,</b>
            about 2hr 30 min
          </p>
        </div>
      </div>
      ...
      {songsData.map((item, index) => (
        ...
        <div onClick={()=>playWithId(item.id)}
          key={index}
          className="grid sm:grid-cols-4 grid-cols-3 gap-2 p-2 items-center text-[#a7a7a7] hover:bg-[#ffffff2b] cursor-pointer"
        >
